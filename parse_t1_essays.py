# -*- coding: utf-8 -*-
"""parse_t1_essays.py — Extract & dedupe Simon IELTS Task 1 model essays
from extracted/*.txt into tool/js/data-t1-essays.js

Records were curated by reading every source file; this script performs:
  - dedupe check (same chart question -> one record, keyed by q[:40])
  - quality gate (essay >= 120 words)
  - JS string escaping via json.dumps and syntax-safe emission
"""
import json, os
from collections import Counter

ROOT = os.path.dirname(os.path.abspath(__file__))
OUT = os.path.join(ROOT, "tool", "js", "data-t1-essays.js")

def E(*paras):
    """Join essay paragraphs with blank lines."""
    return "\n\n".join(paras)
...
R.append((
 ...
 "line", "小作文1",
 E("The line graph compares average yearly spending by Americans on mobile and landline phone services from 2001 to 2010.",
...
R.append((
 ...
 "line", "小作文1",
 E("The chart compares average figures for temperature and precipitation over the course of a calendar year in Kolkata.",
...
R.append((
 ...
 "line", "小作文1",
 E("The line graph compares the percentage of people aged 65 or more in three countries over a period of 100 years.",
...
R.append((
 ...
 "line", "小作文2",
 E("The chart gives information about UK immigration, emigration and net migration between 1999 and 2008.",
...
R.append((
 ...
 "line", "task1博客",
 E("The line graph compares the percentage of people in three countries who used the Internet between 1999 and 2009.",
...
R.append((
 ...
 "line", "小作文1",
 E("The line graph compares figures for daily travel by workers in the UK using three different forms of transport over a period of 60 years.",
...
R.append((
 ...
 "line", "worksheet21",
 E("The line graph compares the amount of electricity produced in France using four different sources of power over a period of 32 years.",
...
R.append((
 ...
 "line", "task1博客",
 E("The line graph shows changes in the per capita consumption of beef, pork, broilers and turkey in the United States between 1955 and 2012.",
...
R.append((
 ...
 "bar", "小作文1",
 E("The bar chart compares the number of incidents and injuries for every 100 million passenger miles travelled on five different types of public transport in 2002.",
...
R.append((
 ...
 "bar", "小作文1",
 E("The bar chart compares twelve countries in terms of the overall number of medals that they have won at the Olympic Games.",
...
R.append((
 ...
 "bar", "小作文2",
 E("The bar chart compares consumer spending on six different items in Germany, Italy, France and Britain.",
...
R.append((
 ...
 "bar", "小作文2",
 E("The bar chart compares the cost of an average house in five major cities over a period of 13 years from 1989.",
...
R.append((
 ...
 "bar", "task1博客",
 E("The bar chart compares the turnover in dollars from sales of video games for four different platforms, namely mobile phones, online, consoles and handheld devices, from 2000 to 2006.",
...
R.append((
 ...
 "bar", "task1博客",
 E("The bar chart shows the number of hot dogs and buns eaten in 15 minutes by the winners of \u2018Nathan\u2019s Hot Dog Eating Contest\u2019 in Brooklyn, USA between 1980 and 2010.",
...
R.append((
 ...
 "bar", "小作文2",
 E("The bar chart compares the number of people in prison in five different countries over a period of 50 years.",
...
R.append((
 ...
 "bar", "worksheet22",
 E("The bar chart compares the number of mobile phones sold worldwide by the five most popular manufacturers in the years 2009, 2011 and 2013.",
...
R.append((
 ...
 "bar", "小作文2",
 E("The three bar charts show average years of schooling, numbers of scientists and technicians, and research and development spending in developing and developed countries. Figures are given for 1980 and 1990.",
...
R.append((
 ...
 "pie", "小作文1",
 E("The pie charts compare the expenditure of a school in the UK in three different years over a 20-year period.",
...
R.append((
 ...
 "pie", "小作文1",
 E("The pie charts compare the amount of electricity produced using five different sources of fuel in two countries over two separate years.",
...
R.append((
 ...
 "pie", "worksheet23",
 E("The pie charts compare five categories of household expenditure in the UK and New Zealand in the years 1980 and 2008.",
...
R.append((
 ...
 "table", "小作文2",
 E("The table gives information about poverty rates among six types of household in Australia in the year 1999.",
...
R.append((
 ...
 "table", "小作文1",
 E("The table shows percentages of consumer expenditure for three categories of products and services in five countries in 2002.",
...
R.append((
 ...
 "table", "小作文2",
 E("The table shows data about the underground rail networks in six major cities.",
...
R.append((
 ...
 "table", "task1博客",
 E("The chart compares the amounts of waste that were produced in six countries in the years 1980, 1990 and 2000.",
...
R.append((
 ...
 "table", "task1博客",
 E("The table compares the numbers of people who cycled to work in twelve areas of the UK in the years 2001 and 2011.",
...
R.append((
 ...
 "table", "小作文1",
 E("The table compares the percentages of people using different functions of their mobile phones between 2006 and 2010.",
...
R.append((
 ...
 "table", "worksheet24",
 E("The table compares the five highest ranking countries in terms of the numbers of visits and the money spent by tourists over a period of two years.",
...
R.append((
 ...
 "two charts", "小作文1",
 E("The bar charts compare students of different ages in terms of why they are studying and whether they are supported by an employer.",
...
R.append((
 ...
 "two charts", "小作文1",
 E("The charts compare the amount of water used for agriculture, industry and homes around the world, and water use in Brazil and the Democratic Republic of Congo.",
...
R.append((
 ...
 "two charts", "小作文1",
 E("The first bar chart shows changes in the number of marriages and divorces in the USA, and the second chart shows figures for the marital status of American adults in 1970 and 2000.",
...
R.append((
 ...
 "two charts", "worksheet25",
 E("The bar chart compares the numbers of males and females who took four different evening classes in 2009, and the pie chart shows the age profile of these attendees.",
...
R.append((
 ...
 "process", "小作文1",
 E("The diagram illustrates the various stages in the life of a honey bee. We can see that the complete life cycle lasts between 34 and 36 days. It is also noticeable that there are five main stages in the development of the honey bee, from egg to mature adult insect.",
...
R.append((
 ...
 "process", "task1博客",
 E("The figure illustrates the process used by the Australian Bureau of Meteorology to forecast the weather.",
...
R.append((
 ...
 "process", "task1博客",
 E("The picture illustrates the process of coffee manufacture and preparation for sale on the market.",
...
R.append((
 ...
 "process", "task1博客",
 E("The flow chart shows how waste paper is recycled. It is clear that there are six distinct stages in this process, from the initial collection of waste paper to the eventual production of usable paper.",
...
R.append((
 ...
 "process", "task1博客",
 E("The picture illustrates the process of producing electricity in a home using solar panels.",
...
R.append((
 ...
 "process", "worksheet26",
 E("The first flow diagram illustrates the process of glass container production, and the second diagram shows steps in the process of recycling used glass.",
...
R.append((
 ...
 "process", "小作文2",
 E("The picture illustrates the way in which water passes from ocean to air to land during the natural process known as the water cycle.",
...
R.append((
 ...
 "map", "map报告",
 E("The map shows the growth of a village called Chorleywood between 1868 and 1994.",
...
R.append((
 ...
 "map", "小作文1",
 E("The diagrams illustrate some changes to a small island which has been developed for tourism.",
...
R.append((
 ...
 "map", "小作文2",
 E("The map shows two potential locations (S1 and S2) for a new supermarket in a town called Garlsdon.",
...
R.append((
 ...
 "comparison", "小作文1",
 E("The diagrams show how house designs differ according to climate.",
...
R.append((
 ...
 "comparison", "小作文1",
 E("The first picture shows the layout of an art gallery, and the second shows some proposed changes to the gallery space.",
...
R.append((
 ...
 "comparison", "worksheet27",
 E("The two pictures compare the current layout of the ground floor of a house with a plan to redesign the same living space.",
...
R.append((
 ...
 "comparison", "task1博客",
 E("The diagrams compare two different methods of defence for homes which are at risk of being flooded.",
...
seen = {}
records = []
for q, chart, src, essay in R:
    key = q[:40]
    assert key not in seen, "DUP key %r (also in %s)" % (key, seen.get(key))
    seen[key] = src
    wc = len(essay.split())
    assert wc >= 120, "Too short (%d words): %s" % (wc, q[:50])
    assert "\n\n" in essay, "Not multi-paragraph: %s" % q[:50]
    records.append({"q": q, "chart": chart, "src": src, "essay": essay})
...
lines = []
lines.append("/* data-t1-essays.js \u2014 Simon Task 1 \u8303\u6587\u5168\u5e93\uff08\u81ea\u52a8\u63d0\u53d6\u53bb\u91cd\uff09 */")
lines.append("/* \u6765\u6e90: extracted/ \u4e0b 13 \u4e2a Simon \u8bed\u6599\u6587\u4ef6; \u540c\u9898\u591a\u7248\u672c\u5df2\u53bb\u91cd\u53d6\u6700\u5b8c\u6574\u7248 */")
lines.append("const T1EssayCorpus = [")
for i, r in enumerate(records):
    lines.append("  {")
    lines.append("    q: %s," % js_str(r["q"]))
    lines.append("    chart: %s," % js_str(r["chart"]))
    lines.append("    src: %s," % js_str(r["src"]))
    lines.append("    essay: %s" % js_str(r["essay"]))
    lines.append("  }%s" % ("," if i < len(records) - 1 else ""))
lines.append("];")
lines.append("")
lines.append("if (typeof module !== 'undefined') module.exports = T1EssayCorpus;")
lines.append("")
...
# ---------------- stats ----------------
dist = Counter(r["chart"] for r in records)
srcs = Counter(r["src"] for r in records)
total_words = sum(len(r["essay"].split()) for r in records)
print("records: %d" % len(records))
for k, v in sorted(dist.items()):
    print("  chart %-11s %d" % (k, v))
print("total essay words: %d" % total_words)
print("avg words/essay: %d" % round(total_words / len(records)))
print("by src:")
